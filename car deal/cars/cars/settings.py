...
SECRET_KEY = 'django-insecure-9dlg9^(c)0b$bs%5r*splpe!6+#$!wng6b$##@n@i=g41o#2gj'
...
INSTALLED_APPS = [
    ...
    'sellcars.apps.SellcarsConfig',
    'bookcars.apps.BookcarsConfig',
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            ...
            'libraries': {
                'custom_filters': 'cars.custom_filters',
            },
        },
    },
]
